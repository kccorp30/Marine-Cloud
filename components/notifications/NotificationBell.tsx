...
import { resolveSoundId, playNotificationSound } from '@/lib/notifications/sound-service';
...
export function NotificationBell({ userId, initialUnreadCount }: { userId: string; initialUnreadCount: number }) {
  ...
  const handleInsert = useCallback(
    (payload: any) => {
      ...
      playNotificationSound(resolveSoundId(notif.event_type, notif.severity));
  ...
  return (
    ...
    </span>}><NotificationInbox key={unreadCount}/></Drawer>
  );
}
