...
export function TopHeader({
  ...
  return (
    <header className="sticky top-0 z-30 h-[74px] flex items-center px-4 lg:px-7 gap-4 bg-[#061321]/82 backdrop-blur-2xl border-b border-white/[0.055] shadow-[0_18px_55px_-45px_rgba(0,0,0,.95)]">
      <button
        type="button"
