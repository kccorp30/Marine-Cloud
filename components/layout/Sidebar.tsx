  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed top-0 left-0 h-screen w-[270px] shrink-0 z-50 lg:z-10 flex flex-col bg-[#061321]/95 border-r border-gold-dim/20 shadow-[18px_0_70px_-45px_rgba(0,0,0,.95)] transition-transform duration-300 marine-waves ${mobileOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}
      >
