-- =========================================================
-- 086_record_manual_payment.sql — Marine Cloud Phase 7
-- =========================================================
-- Solo staff/kcc_admin. Row lock + chequeo contra balance real (no
-- el cacheado) — rechaza sobrepago. stripe_card bloqueado de este
-- camino manual a propósito. Dispara invoice -> payment vía
-- transition_work_order() real cuando la invoice queda saldada.
-- Verificado: customer bloqueado, sobrepago rechazado, facturar por
-- encima del autorizado rechazado.
-- =========================================================
...
revoke execute on function record_manual_payment(uuid, numeric, text, text, timestamptz, text) from public, anon;
grant execute on function record_manual_payment(uuid, numeric, text, text, timestamptz, text) to authenticated;
